...
using PixelMatrixEditor.Graphics;
...
namespace PixelMatrixEditor
{
    ...
    public partial class PixelMatrixView : UserControl
    {
        ...
        public static readonly DependencyProperty MatrixSourceProperty =
             DependencyProperty.Register("MatrixSource", typeof(Matrix),
        ...
        private static void MatrixSourceChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            view.UpdateRenderer((Matrix)e.NewValue);
        }

        // .NET Property wrapper
        public Matrix MatrixSource
        {
            get { return (Matrix)GetValue(MatrixSourceProperty); }
        ...
        #endregion
        private void UpdateRenderer(Matrix matrix)
        {
