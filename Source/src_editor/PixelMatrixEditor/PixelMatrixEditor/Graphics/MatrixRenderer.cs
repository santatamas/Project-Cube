...
using PixelMatrixEditor.Helpers;
using PixelMatrixEditor.Models;
using Matrix = PixelMatrixEditor.Models.Matrix;

namespace PixelMatrixEditor.Graphics
{
    public class MatrixRenderer :INotifyPropertyChanged
    {
        ...
        private unsafe void Render()
        {
            ...
            for (int i = 0; i < _settings.SizeX; i++)
            {
                ...
                {
                    currentPixelColor = _matrix.Data[i, j] ? _pixelOnBrush : _pixelOffBrush;
